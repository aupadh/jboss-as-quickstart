 ...
 * 
 */
public class UserTxJBossApiClient {
  private static final Logger LOGGER = Logger.getLogger(UserTxJBossApiClient.class.getName());
  ...
  public UserTxJBossApiClient(Boolean secured, boolean useDefaultUser, String user, String password, Boolean debug) {
  ...
  private void invoke() throws Exception {
    ...
    final UserTransaction ut = EJBClient.getUserTransaction("master:app-twoB");
    ut.begin();
    try {
      ...
      for (int i = 1; i < 20; i++) {
        final String result = remote.invoke("Client call #"+i+" at " + new Date());
  ...
  public static void main(String[] args) throws Exception {
    ...
    UserTxJBossApiClient client = new UserTxJBossApiClient(secured, useDefaultCredentials, user, passwd, debug);
