 ...
 *
 */
public class SimpleScopedContextClient {
    private static final Logger LOGGER = Logger.getLogger(SimpleScopedContextClient.class.getName());
    ...
    public SimpleScopedContextClient(Boolean secured, boolean local, String user, String password, Boolean debug) throws NamingException {
    ...
    private void createContext(String name) throws NamingException {
      this.context = createContext(name, "localhost", 4647, this.user != null ? this.user : this.local ? null : "", this.password);
    }
    ...
    private void invokeAppTwo() throws NamingException {
    ...
    public static void main(String[] args) throws NamingException {
        ...
        SimpleScopedContextClient client = new SimpleScopedContextClient(secured, local, user, passwd, debug);
